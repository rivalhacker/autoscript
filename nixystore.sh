...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  WELCOME TO MY SCRIPT ${YELLOW}(${NC}${green} Free Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Author : ${green} » ${NC}${YELLOW}(${NC} ${green} CAPCAPAN ${NC}${YELLOW})${NC}"
echo -e " © RECODE BY MY SELF CAPCAPAN ${YELLOW}(${NC} 2020 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
